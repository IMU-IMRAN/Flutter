...
class MyDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   // final imageUrl =
   //     "https://www.freepik.com/icon/avatar_147144";
    return Drawer(
      child: Container(
            ...
            DrawerHeader(
              ...
              child: UserAccountsDrawerHeader(
               ...
               // decoration: BoxDecoration(color: Colors.red),
                accountName: Text("SK IMRAN"),
                accountEmail: Text("skimranxz@gmail.com"),
                currentAccountPicture: Image.asset("photos/images/imran_copy.jpg"),
              ),
            ),
             ListTile(
